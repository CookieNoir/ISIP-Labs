В этом приложении содержатся лабораторные 1 - 5 по курсу ИБЗИ.
Приложение можно запустить с гитхаба, перейдя по ссылке:

https://cookienoir.github.io/ISIP-Labs/

Если есть желание запустить приложение локально (настоятельно не рекомендую), то ниже представлены действия,
которые, в зависимости от браузера, необходимо сделать для успешного запуска:
